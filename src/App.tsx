...
function App() {
	...
	const currentRoute =
		stack.length > 0 ? stack[stack.length - 1].route : undefined;
			...
			<div className="flex flex-col gap-6 h-full justify-center">
				...
				<div className="w-80 bg-white/5 border border-white/10 rounded-xl p-4 text-xs text-gray-400">
					...
					<ul className="list-disc list-inside space-y-1">
						<li>
							<strong className="text-blue-400">Navigate</strong>: Go to screen.
							If exists, pop back to it.
						</li>
						<li>
							<strong className="text-purple-400">Push</strong>: Always add new
							screen on top.
						</li>
						<li>
							<strong className="text-orange-400">Replace</strong>: Swap current
							screen with new one.
						</li>
						<li>
							<strong className="text-red-400">DismissTo</strong>: Pop until
							specific screen is reached.
						</li>
					</ul>
				</div>
			</div>
